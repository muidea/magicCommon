...
// BenchmarkResultSetMethods 结果集方法性能测试
func BenchmarkResultSetMethods(b *testing.B) {
...
// BenchmarkTransactionMethods 事务方法性能测试
func BenchmarkTransactionMethods(b *testing.B) {
	baseDao := &BaseDao{}
...
// BenchmarkCRUDMethods CRUD方法性能测试
func BenchmarkCRUDMethods(b *testing.B) {
	baseDao := &BaseDao{}
...
// BenchmarkCompositeOperations 复合操作性能测试
...
// BenchmarkLongRunning 长时间运行性能测试
